...
JLabel lblMartialStatus = new JLabel("Martialstatus :");
...
signUp.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==signUp) {
			...
			ad.setMartial_Status(MartialStatustext.getText());
			...
			ad.insertData();
			System.out.print(ad.getFname() + " " + ad.getLname() + " " + ad.getGender() + " " + ad.getPhone() + " " + ad.getMartial_Status() + " " + ad.getDoB() + " " + ad.getEmail() + " " + ad.getPassword() );
		}
	}
});
